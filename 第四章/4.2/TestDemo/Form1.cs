        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                try
                {
                    ...
                    float a21 = (float)Convert.ToDouble(textBox4.Text);
                    float a22 = (float)Convert.ToDouble(textBox5.Text);
                    float a13 = (float)Convert.ToDouble(textBox3.Text);
                    float a23 = (float)Convert.ToDouble(textBox6.Text);
                    float a31 = (float)Convert.ToDouble(textBox9.Text);
                    float a32 = (float)Convert.ToDouble(textBox8.Text);
                    float a33 = 1.0f;
                    float[] H = new float[] { a11, a12, a13, a21, a22, a23, a31, a32, a33 };
                    DateTime start = DateTime.Now;
                    curBitmap = ImageProcessDll.PerspectiveTransform(srcBitmap, H);
