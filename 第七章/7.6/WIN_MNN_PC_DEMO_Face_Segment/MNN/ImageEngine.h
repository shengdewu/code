...
/************************************************************
*Function:  SF_AI_Softskin
*Description: Face SoftSkin
*Params:
*srcData:  image bgra data
*width  :image width
*height :image height
*stride :image stride
*ratio: intensity of softskin, [0,100].
*Return :0-OK,or failed
************************************************************/
EXPORT int SF_AI_Softskin(unsigned char* srcData, int width, int height, int stride, int ratio);
#else
...
extern "C" {
	...
	int SF_AI_Softskin(unsigned char* srcData, int width, int height, int stride, int ratio);
	}
#endif
#endif
