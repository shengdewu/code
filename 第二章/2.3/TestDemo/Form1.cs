...
namespace TestDemo
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                int cenX = Convert.ToInt32(textBox1.Text);
                int cenY = Convert.ToInt32(textBox2.Text);
                int k = Convert.ToInt32(textBox3.Text);
                curBitmap = zp.HahaFilter(srcBitmap, cenX, cenY, k, 0);
                pictureBox1.Image = curBitmap;
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                ...
                int cenY = Convert.ToInt32(textBox2.Text);
                int k = Convert.ToInt32(textBox3.Text);
                curBitmap = zp.HahaFilter(srcBitmap, cenX, cenY, k, 1);
                pictureBox1.Image = curBitmap;
            }
        }
    }
