...
namespace TestDemo
{
    unsafe class ImageProcessDll
    {
        ...
        private static extern int f_SmartBlur(byte* srcData, int nWidth, int nHeight, int nStride, int radius, int threshold);

        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        public static Bitmap SmartBlur(Bitmap src, int radius, int threshold)
        {
            ...
            f_SmartBlur((byte*)srcData.Scan0, dst.Width, dst.Height, srcData.Stride, radius, threshold);
