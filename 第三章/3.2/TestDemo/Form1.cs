...
namespace TestDemo
{
    public partial class Form1 : Form
    {
        ...
        {
            System.Diagnostics.Process.Start("http://www.zealpixel.com");  
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                ...
                int threshold = Convert.ToInt32(textBox2.Text.ToString());
                DateTime start = DateTime.Now;
                curBitmap = ImageProcessDll.SurfaceBlur(srcBitmap, radius, threshold);
