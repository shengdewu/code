...
namespace TestDemo
{
    public partial class Form1 : Form
    {
        ...
        //磨皮程度变量
        private int softRatio = 0;
        //美白程度变量
        private int skinWhiteRatio = 0;
        //肤色程度变量
        private int skinColorRatio = 0;
        //清晰度程度变量
        private int sharpenRatio = 0;
        #endregion
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                ...
                curBitmap = ImageProcessDll.BeautyCamera(srcBitmap, softRatio, skinWhiteRatio, skinColorRatio, sharpenRatio);
        ...
        {
            softRatio = hScrollBar1.Value;
            textBox1.Text = hScrollBar1.Value.ToString();
            skinWhiteRatio = hScrollBar2.Value;
            textBox2.Text = hScrollBar2.Value.ToString();
            skinColorRatio = hScrollBar3.Value;
        ...
        {
            sharpenRatio = Convert.ToInt32(textBox4.Text);
        }
