...
namespace TestDemo
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                int radius = Convert.ToInt32(textBox2.Text.ToString());
                float std = (float)Convert.ToDouble(textBox1.Text);
                DateTime start = DateTime.Now;
                curBitmap = ImageProcessDll.BilateralFilters(srcBitmap,radius, std);
