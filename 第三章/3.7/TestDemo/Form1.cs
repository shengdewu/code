...
namespace TestDemo
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                int Radius = Convert.ToInt32(textBox5.Text.ToString());
                int Threshold = Convert.ToInt32(textBox4.Text.ToString());
                int maxIter = Convert.ToInt32(textBox1.Text.ToString());
                DateTime start = DateTime.Now;
                curBitmap = ImageProcessDll.MeanShiftFilter(srcBitmap, Radius, Threshold, maxIter);
