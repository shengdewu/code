...
namespace TestDemo
{
    public partial class Form1 : Form
    {
        ...
        private int highThreshold = 128;
        private int lowThreshold = 30;
        private void button2_Click(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                highThreshold = Convert.ToInt32(textBox1.Text);
                lowThreshold = Convert.ToInt32(textBox2.Text);
                curBitmap = zp.CannyEdgedetection(srcBitmap, highThreshold,lowThreshold);
                pictureBox1.Image = curBitmap;
            }
        }
