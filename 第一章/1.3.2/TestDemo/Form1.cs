...
namespace TestDemo
{
    public partial class Form1 : Form
    {
        ...
        private float sIntensity = 0;
        private float hIntensity = 0;
        private float vIntensity = 0;
        private void hScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            hIntensity = hScrollBar1.Value;
            textBox1.Text = hScrollBar1.Value.ToString();
            sIntensity = hScrollBar2.Value / 100.0f;
            textBox2.Text = sIntensity.ToString();
            vIntensity = hScrollBar3.Value / 100.0f;
            textBox3.Text = vIntensity.ToString();
            curBitmap = zp.HSVAdjust(srcBitmap, hIntensity, sIntensity, vIntensity);
            pictureBox1.Image = curBitmap;
        }
